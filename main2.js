...
let buscar = document.getElementById("botonBuscar")
        buscar.addEventListener("click", () => {
            reproductor.buscarCancion(document.getElementById("buscardor").value)
        });
        console.log("hola");
...
class playlist {
    ...
    constructor(nombrePlaylist, listaCanciones, orderEscuchar) {
...
class reproductor {
    ...
    mostrarCancion = function () {
        ...
        this.catalogodeCanciones.forEach(can => {
            songs.innerHTML += `<li id="busqueda_${catalogodeCanciones.id}" class="cancion">${catalogodeCanciones.nombre}
            </li>;`
        });
    }
